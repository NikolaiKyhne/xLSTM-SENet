...
def main():
    ...
    make_json(
        ...
        'xlSTMSENet/data/train_clean.json'
    )

    ## train_noisy
    make_json(
        os.path.join(prefix, 'noisy_trainset_28spk_wav_16k/'),
        'xLSTM-SENet/data/train_noisy.json'
    )
    # ----------------------------------------------------------#
    ...
    make_json(
        ...
        'xLSTM-SENet/data/valid_clean.json'
    )

    ## valid_noisy
    make_json(
        os.path.join(prefix, 'noisy_testset_wav_16k/'),
        'xLSTM-SENet/data/valid_noisy.json'
    )
    # ----------------------------------------------------------#
    ...
    make_json(
       os.path.join(prefix, 'clean_testset_wav_16k/'),
        'xLSTM-SENet/data/test_clean.json'
    )

    ## test_noisy
    make_json(
       os.path.join(prefix, 'noisy_testset_wav_16k/'),
        'xLSTM-SENet/data/test_noisy.json'
    )
    # ----------------------------------------------------------#
